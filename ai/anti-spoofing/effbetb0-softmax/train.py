...
def main() -> None:
    ...
    parser.add_argument("--config_path", default="effbetb0-softmax/train_config.yml", help="Path to config yml")
    ...
    save_dir = Path(config.get("save_dir", "models/anti_spoofing/effbetb0_softmax"))
    ...
    for epoch in range(1, epochs + 1):
        ...
        if val_loader is not None:
            ...
            if val_acc > best_val_acc:
                ...
                ckpt_path = save_dir / "efficientnet_b0_softmax_best.pt"
