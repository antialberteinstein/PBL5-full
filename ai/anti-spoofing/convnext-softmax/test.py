...
def main() -> None:
    ...
    parser.add_argument("--config_path", default="convnext-softmax/test.yml", help="Path to config file")
    ...
    ckpt_path = Path(config.get("ckpt_path", "models/anti_spoofing/convnext_softmax/convnext_softmax_best.pt"))
