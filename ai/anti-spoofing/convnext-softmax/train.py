...
def main() -> None:
    ...
    parser.add_argument("--config_path", default="convnext-softmax/train_config.yml", help="Path to config yml")
    ...
    save_dir = Path(config.get("save_dir", "models/anti_spoofing/convnext_softmax"))
    ...
    model = ConvNextClassifier(num_classes=num_classes, pretrained=True).to(device)
    ...
    for epoch in range(1, epochs + 1):
        ...
        if val_loader is not None:
            ...
            if val_acc > best_val_acc:
                ...
                ckpt_path = save_dir / "convnext_softmax_best.pt"
